...
\begin{frame}{Influence of the compression algorithm}
  ...
  \begin{minipage}[h]{.45\linewidth}
    \begin{figure}[htbp]
      \centering
      \includegraphics[width=\linewidth]{../figures/order_increase}
      \caption{Rule 82}
    \end{figure}
...
\begin{frame}{Extreme cases --- Illustration}
  ...
  \begin{figure}[htbp]
    ...
    \begin{subfigure}{.49\linewidth}
      ...
      % {../rule_gif/pngs/13463141642615599940-10}
    ...
    \begin{subfigure}{.49\linewidth}
      \centering
      % \includegraphics[width=\linewidth]
      % {../rule_gif/pngs/3891041186864560738-10}
      \animategraphics[loop,controls,width=\linewidth]{5}
...
\begin{frame}{Intermediate cases --- Illustration}
  ...
  \begin{figure}[htbp]
    ...
    \begin{subfigure}{.49\linewidth}
      \centering
      % \includegraphics[width=\linewidth]
      % {../rule_gif/pngs/1461082546904894069-15}
      \animategraphics[loop,controls,width=\linewidth]{5}
    ...
    \begin{subfigure}{.49\linewidth}
      \centering
      % \includegraphics[width=\linewidth]
      % {../rule_gif/pngs/16172727384030072437-15}
      \animategraphics[loop,controls,width=\linewidth]{5}
...
\begin{frame}{Example rules --- 2 states}
  \begin{figure}[htbp]
    ...
    \begin{subfigure}{.32\linewidth}
      \centering
      % \includegraphics[width=\linewidth]
      % {../rule_gif/pngs/5526130398097930830-15}
      \animategraphics[loop,controls,width=\linewidth]{5}
    ...
    \begin{subfigure}{.32\linewidth}
      ...
      % {../rule_gif/pngs/6349956867804255879-15}
      \animategraphics[loop,controls,width=\linewidth]{5}
    ...
    \begin{subfigure}{.32\linewidth}
      \centering
      % \includegraphics[width=\linewidth]
      % {../rule_gif/pngs/6116844074278280215-15}
      \animategraphics[loop,controls,width=\linewidth]{5}
...
\begin{frame}{Langton's lambda parameter}
  ...
  \begin{figure}[htbp]
    \centering
    \includegraphics[width=.5\linewidth]{../figures/rule_22_transitions}
  \end{figure}
...
\begin{frame}{Relation to lambda parameter}
  ...
  \begin{figure}[htbp]
    \centering
    \includegraphics[width=.6\linewidth]{../figures/lambda_prop}
...
\begin{frame}{Example rules --- 3 states}
  \begin{figure}[htbp]
    ...
    \begin{subfigure}{.49\linewidth}
      \centering
      % \includegraphics[width=\linewidth]
      % {../rule_gif/pngs/2656185470595024321_3-15}
      \animategraphics[loop,controls,width=\linewidth]{5}
    ...
    \begin{subfigure}{.49\linewidth}
      \centering
      % \includegraphics[width=\linewidth]
      % {../rule_gif/pngs/6395857399678607410_3-15}
      \animategraphics[loop,controls,width=\linewidth]{5}
...
\begin{frame}{}
  ...
  \begin{minipage}[h]{.68\linewidth}
      ...
      % {../rule_gif/pngs/17049424499849263338_3-140}
      \animategraphics[loop,width=1.2\linewidth]{40}
